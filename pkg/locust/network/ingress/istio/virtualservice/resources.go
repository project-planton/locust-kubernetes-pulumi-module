...
import (
	"fmt"
	"github.com/plantoncloud/locust-kubernetes-pulumi-blueprint/pkg/locust/network/ingress/netutils/port"
	"path/filepath"
...
func buildVirtualServiceObject(i *input) *v1beta1.VirtualService {
	...
	var resourceId = i.resourceId
	var resourceName = i.resourceName
	var nameSpaceName = i.namespaceName
	var hostNames = []string{i.externalHostname}
